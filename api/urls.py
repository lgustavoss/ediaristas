...
from .views import (diaristas_localidade_view, endereceo_cep_view, disponibilidade_atendimento_cidade, inicio_view, servico_view, usuario_view)

urlpatterns = [
    path('diaristas/localidades', diaristas_localidade_view.DiaristasLocalidades.as_view(), name='diaristas-localidades-list'),
    path('enderecos', endereceo_cep_view.EnderecoCep.as_view(), name='endereco-cep-list'),
